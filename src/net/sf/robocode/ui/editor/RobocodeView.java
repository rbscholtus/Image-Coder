 ...
 *     Flemming N. Larsen
 *     - Added syntax highlighting for annotations
 *******************************************************************************/
...
public class RobocodeView extends PlainView {
    ...
    public final static Color commentColor = new Color(150, 150, 150);
    public final static Color stringColor = new Color(206, 123, 0);
    public final static Color keywordColor = new Color(0, 0, 230);
    public final static Color annotationColor = new Color(150, 150, 150);
